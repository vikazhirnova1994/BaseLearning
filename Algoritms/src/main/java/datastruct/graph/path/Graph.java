...
public class Graph {
    ...
    private DistPar sPath[]; //массив кратчайщих путей
    private int currentVert;//текущая вершина
    private int startToCurrent;//расстояние до текущей вершины
    ...
    public void path() {
            ...
            while(nTree < nVerts) {
                ...
                nTree++;
                adjust_Path(); // Обновление массива sPath[]
            }
    ...
    public void adjust_Path() { //обновление данных в масииве кратчайших путей
